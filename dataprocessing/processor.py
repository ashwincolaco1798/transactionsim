...
for transaction_size in transaction_sizes:
    for isolation_mode in isolation_modes:
        ...
        plt.savefig("/home/yap/tippers/dataprocessing/Graphs High Concurrency/Throughput vs MPL "+str(transaction_size)+" and Isolation Mode "+isolation_mode+".png")
        plt.close()
        ...
        plt.title("Throughput vs MPL for Transaction size "+str(transaction_size)+" and Isolation Mode "+isolation_mode)
        plt.savefig("/home/yap/tippers/dataprocessing/Graphs High Concurrency/Average Query Response Time vs MPL "+str(transaction_size)+" and Isolation Mode "+isolation_mode+".png")
        plt.close()
        plt.scatter(insert_response_dataframe['mpl_level'], insert_response_dataframe['Insert Response Time'])
        plt.xlabel('MPL Level')
        plt.ylabel('Average response time in ms')
        plt.title("Throughput vs MPL for Transaction size "+str(transaction_size)+" and Isolation Mode "+isolation_mode)
        plt.savefig("/home/yap/tippers/dataprocessing/Graphs High Concurrency/Average Insert Response Time vs MPL "+str(transaction_size)+ " and Isolation Mode "+isolation_mode+".png")
        plt.close()
